    ...
    const responseData = transform({
      ...
      return {
        ...
        links: [
          {
            type: "terms_of_use",
            value: "https://junooni.com/in/terms-condition", // TODO: replace with actual terms of use
          },
          {
            type: "privacy_policy",
            value: "https://junooni.com/in/privacy-policy", // TODO: replace with actual privacy policy
          },
        //   {
