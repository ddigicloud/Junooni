  ...
  do {
    ...
    for (const product of products) {
      ...
      for (const variant of product.variants) {
        ...
        // Skip variants with no price for this currency
        if (
            !calculatedPrice ||
        ...
        feedItems.push({
          ...
          size: size || undefined,
          seller_name: "JUNOONI", // TODO add seller name if supported
          seller_url: storefrontUrl || "",
          seller_privacy_policy: `${storefrontUrl}/privacy-policy`, // TODO update
          seller_tos: `${storefrontUrl}/terms-condition`, // TODO update
          return_policy: `${storefrontUrl}/refund-exchange`, // TODO update
