    ...
    <div className="min-h-screen bg-gray-100">      
      <div className="container px-4 py-8 mx-auto">
        <div className="flex flex-col gap-6 md:flex-row">
          {/* Sidebar Navigation */}
          <aside className="w-full p-4 bg-white rounded-lg shadow-sm md:w-1/4 lg:w-1/5 h-fit">
            ...
            <nav>
              ...
              <div className="pt-6 mt-6 border-t">
                <button className="flex items-center w-full gap-3 px-4 py-2 text-gray-700 transition rounded-lg hover:bg-gray-100">
                  <LogOut size={18} />
                  <span>Sign Out</span>
                </button>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-4 mb-6 md:grid-cols-3">
                    ...
                    {orders.length > 0 ? (
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="mb-1 text-sm text-gray-600">{orders[0].date}</div>
                          <div className="flex items-center">
                  ...
                  <div className="p-5 bg-white rounded-lg shadow-sm">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex items-center justify-center flex-shrink-0 bg-yellow-100 rounded-full w-14 h-14">
                        <Star size={24} className="text-yellow-600" />
                      </div>
                      <div>
                        <div className="font-medium">{user.points} Points</div>
                        <div className="mb-1 text-sm text-gray-600">{user.membershipTier} Member</div>
                        <div className="text-sm">
                          <span className="font-medium text-green-600">50 points</span> until next reward
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-6 mb-6 bg-white rounded-lg shadow-sm">
                  ...
                  <div className="space-y-4">
                    {upcomingEvents.map(event => (
                      <div key={event.id} className="flex items-center p-3 transition border border-gray-100 rounded-lg hover:border-gray-200">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
                    {wishlistItems.slice(0, 4).map(item => (
                      <div key={item.id} className="transition border border-gray-200 rounded-lg group hover:border-gray-300">
                        ...
                        <div className="p-3">
                          <div className="mb-1 text-xs text-gray-500">{item.creator}</div>
            ...
            {activeTab === 'orders' && (
              <div>
                <div className="p-6 mb-6 bg-white rounded-lg shadow-sm">
                  ...
                  <div className="space-y-4">
                    {orders.map(order => (
                      <div key={order.id} className="overflow-hidden border border-gray-200 rounded-lg">
                        {/* Order Header */}
                        <div 
                          ...
                          <div className="p-4">
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                              ...
                              <div className="md:col-span-2">
                                ...
                                {/* Order Timeline */}
                                <h4 className="mt-6 mb-3 font-medium">Tracking History</h4>
              ...
              <div>
                <div className="mb-6 overflow-hidden bg-white rounded-lg shadow-sm">
                  ...
                  <div className="bg-gradient-to-r from-[#e65100] to-[#ff9800] text-white p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <h1 className="mb-2 text-2xl font-bold">Gold Fan Status</h1>
                  ...
                  {/* Membership Benefits */}
                  <div className="p-6">
                    <h2 className="mb-4 text-lg font-semibold">Your Gold Fan Benefits</h2>
                    ...
                    <div className="mt-6">
                      <h3 className="mb-3 font-medium">Next Tier: Platinum Fan (2,500 points)</h3>
                    ...
                    <table className="min-w-full">
                      ...
                      <tbody className="divide-y">
                        <tr>
                          ...
                          <td className="px-4 py-3 text-right text-green-600">+160</td>
                          <td className="px-4 py-3 font-medium text-right">2,450</td>
                        </tr>
                        <tr>
                          ...
                          <td className="px-4 py-3 text-right text-green-600">+50</td>
                          <td className="px-4 py-3 font-medium text-right">2,290</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-3 text-sm">February 28, 2025</td>
                          <td className="px-4 py-3">
                            <div className="font-medium">Purchase</div>
                            <div className="text-sm text-gray-500">Order #ORD-9875</div>
                          </td>
                          <td className="px-4 py-3 text-right text-green-600">+260</td>
                          <td className="px-4 py-3 font-medium text-right">2,240</td>
                        </tr>
                        <tr>
                          ...
                          <td className="px-4 py-3 text-right text-green-600">+25</td>
                          <td className="px-4 py-3 font-medium text-right">1,980</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-3 text-sm">January 15, 2025</td>
                          <td className="px-4 py-3">
                            <div className="font-medium">Purchase</div>
                            <div className="text-sm text-gray-500">Order #ORD-9738</div>
                          </td>
                          <td className="px-4 py-3 text-right text-green-600">+72</td>
                          <td className="px-4 py-3 font-medium text-right">1,955</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                ...
                <div className="p-6 bg-white rounded-lg shadow-sm">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="px-3 py-1 text-sm text-yellow-800 bg-yellow-100 rounded-full">Gold Access</span>
                  </div>
                  
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    {[1, 2, 3].map(item => (
                      <div key={item} className="overflow-hidden border border-gray-200 rounded-lg group">
                        <div className="relative aspect-video">
                          ...
                          <div className="absolute bottom-0 left-0 w-full p-4">
                            <div className="font-medium text-white">Exclusive Content {item}</div>
                          </div>
                        </div>
