      ...
      {selectedImageIndex !== null && (
        ...
        >
          ...
          >
            {/* Close button */}
            <button 
              className="absolute z-10 p-2 bg-white rounded-full top-4 right-4 hover:bg-gray-100"
              onClick={closeLightbox}
            ...
            {/* Previous button */}
            <button 
              className="absolute z-10 p-3 -translate-y-1/2 rounded-full left-4 top-1/2 bg-white/80 hover:bg-white"
              onClick={(e) => {
                e.stopPropagation();
                prevLightboxImage();
              }}
            ...
            {/* Next button */}
            <button 
              className="absolute z-10 p-3 -translate-y-1/2 rounded-full right-4 top-1/2 bg-white/80 hover:bg-white"
              onClick={(e) => {
                e.stopPropagation();
                nextLightboxImage();
              }}
