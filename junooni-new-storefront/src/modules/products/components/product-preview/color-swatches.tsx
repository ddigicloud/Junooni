  ...
  return (
    mergedColors.length > 0 && (
      <div className="pt-3 mt-auto pointer-events-auto">
        <ul className="flex items-center gap-x-1 flex-wrap">
          ...
          {!showAll && hiddenCount > 0 && (
            <li>
              <button
                className="w-6 h-6 flex items-center justify-center border border-gray-300 rounded-full text-xs bg-white hover:bg-gray-100"
