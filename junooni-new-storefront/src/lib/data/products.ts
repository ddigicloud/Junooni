    ...
    .fetch<{ products: HttpTypes.StoreProduct[]; count: number }>(
      `/store/products`,
      {
        ...
        query: {
          ...
          region_id: region?.id,
          fields:
            "*variants.calculated_price,+variants.inventory_quantity,+metadata,+tags,+vendor,+options,+images,+variants.prices,+variants.prices.amount",
          ...queryParams,
        },
        headers,
        next,
...
export const retrieveProductById = async ({
  ...
  try {
    return await sdk.client.fetch<HttpTypes.StoreProduct>(
      `/store/products/${id}`,
      {
        method: "GET",
        query: {
