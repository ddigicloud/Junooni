          ...
          <CCol md={9} lg={7} xl={6}>
            <CCard className="mx-4">
              <CCardBody className="p-4">
                <CForm
                  onSubmit={step === 1 ? handleEmailPasswordSubmit : handleVendorProfileSubmit}
                >
                  <h1>
                    {step === 1 ? 'Vendor Registration - Step 1' : 'Vendor Registration - Step 2'}
                  </h1>
                  <p className="text-body-secondary">
                    {step === 1 ? 'Enter your email and password' : 'Complete your vendor profile'}
                  </p>
                  ...
                  {message && (
                    <div className="mt-3">
                      <p
                        className={`text-center ${message.includes('successful') ? 'text-success' : 'text-danger'}`}
                      >
                        {message}
                      </p>
                    </div>
