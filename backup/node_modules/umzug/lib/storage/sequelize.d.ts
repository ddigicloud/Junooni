...
declare type ModelTempInterface = {} & ModelClass & Record<string, any>;
/**
 ...
 */
export declare type ModelClass = {
    tableName: string;
 ...
 */
export declare type SequelizeType = {
...
declare type _SequelizeStorageConstructorOptions = {
    /**
