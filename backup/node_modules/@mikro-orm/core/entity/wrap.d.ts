import type { IWrappedEntity, IWrappedEntityInternal, PrimaryProperty } from '../typings';
/**
 ...
 * @internal
 */
export declare function helper<T, PK extends keyof T | unknown = PrimaryProperty<T>>(entity: T): IWrappedEntityInternal<T, PK>;
