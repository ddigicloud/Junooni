...
class EntitySchema {
    ...
    initProperties() {
        Object.entries(this._meta.properties).forEach(([name, options]) => {
            options.type ?? (options.type = options.customType != null ? options.customType.constructor.name : options.type);
    ...
    initPrimaryKeys() {
        ...
        if (pks.length > 0) {
            ...
            this._meta.simplePK = !this._meta.compositePK && pks[0].reference === enums_1.ReferenceType.SCALAR && !pks[0].customType;
        }
