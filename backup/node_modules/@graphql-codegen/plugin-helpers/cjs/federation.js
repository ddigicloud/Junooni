...
class ApolloFederation {
    ...
    skipField({ fieldNode, parentType }) {
        if (!this.enabled || !(0, graphql_1.isObjectType)(parentType) || !checkObjectTypeFederationDetails(parentType, this.schema)) {
            return false;
        }
 ...
 * @param node Type
 */
function checkObjectTypeFederationDetails(node, schema) {
