 ...
 */
export declare const createInventoryLevelsStep: import("@medusajs/framework/workflows-sdk").StepFunction<InventoryTypes.CreateInventoryLevelInput[], InventoryTypes.InventoryLevelDTO[]>;
