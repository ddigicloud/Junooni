 ...
 */
export declare const createInventoryItemsStep: import("@medusajs/framework/workflows-sdk").StepFunction<InventoryTypes.CreateInventoryItemInput[], InventoryTypes.InventoryItemDTO[]>;
