 ...
 */
export declare const updateInventoryItemsStep: import("@medusajs/framework/workflows-sdk").StepFunction<InventoryTypes.UpdateInventoryItemInput[], InventoryTypes.InventoryItemDTO[]>;
