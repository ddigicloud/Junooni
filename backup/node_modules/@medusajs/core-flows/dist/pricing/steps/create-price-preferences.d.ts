 ...
 */
export declare const createPricePreferencesStep: import("@medusajs/framework/workflows-sdk").StepFunction<PricingWorkflow.CreatePricePreferencesWorkflowInput[], import("@medusajs/framework/types").PricePreferenceDTO[]>;
