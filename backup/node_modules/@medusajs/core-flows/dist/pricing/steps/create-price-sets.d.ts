 ...
 */
export declare const createPriceSetsStep: import("@medusajs/framework/workflows-sdk").StepFunction<CreatePriceSetDTO[], import("@medusajs/framework/types").PriceSetDTO[]>;
