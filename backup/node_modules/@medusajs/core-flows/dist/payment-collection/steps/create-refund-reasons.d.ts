 ...
 */
export declare const createRefundReasonStep: import("@medusajs/framework/workflows-sdk").StepFunction<CreateRefundReasonDTO[], import("@medusajs/framework/types").RefundReasonDTO[]>;
