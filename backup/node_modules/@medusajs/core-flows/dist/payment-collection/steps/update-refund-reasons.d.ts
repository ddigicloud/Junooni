 ...
 */
export declare const updateRefundReasonsStep: import("@medusajs/framework/workflows-sdk").StepFunction<UpdateRefundReasonDTO[], import("@medusajs/framework/types").RefundReasonDTO[]>;
