 ...
 */
export declare const createStockLocations: import("@medusajs/framework/workflows-sdk").StepFunction<CreateStockLocationInput[], import("@medusajs/framework/types").StockLocationDTO[]>;
