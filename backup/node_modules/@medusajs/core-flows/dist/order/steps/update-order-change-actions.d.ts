 ...
 */
export declare const updateOrderChangeActionsStep: import("@medusajs/framework/workflows-sdk").StepFunction<UpdateOrderChangeActionDTO[], import("@medusajs/framework/types").OrderChangeActionDTO[]>;
