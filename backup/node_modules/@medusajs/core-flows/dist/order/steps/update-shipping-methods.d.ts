 ...
 */
export declare const updateOrderShippingMethodsStep: import("@medusajs/framework/workflows-sdk").StepFunction<UpdateOrderShippingMethodDTO[], import("@medusajs/framework/types").OrderShippingMethodDTO[]>;
