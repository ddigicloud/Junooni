 ...
 */
export declare const createOrderWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<CreateOrderDTO & AdditionalData, import("@medusajs/framework/types").OrderDTO, import("@medusajs/framework/workflows-sdk").Hook<"orderCreated", {
