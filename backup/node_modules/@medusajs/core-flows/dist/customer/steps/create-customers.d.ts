 ...
 */
export declare const createCustomersStep: import("@medusajs/framework/workflows-sdk").StepFunction<CreateCustomerDTO[], import("@medusajs/framework/types").CustomerDTO[]>;
