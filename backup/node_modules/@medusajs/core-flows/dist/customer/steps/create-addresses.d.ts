 ...
 */
export declare const createCustomerAddressesStep: import("@medusajs/framework/workflows-sdk").StepFunction<CreateCustomerAddressDTO[], import("@medusajs/framework/types").CustomerAddressDTO[]>;
