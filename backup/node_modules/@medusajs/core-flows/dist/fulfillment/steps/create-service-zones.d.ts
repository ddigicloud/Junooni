 ...
 */
export declare const createServiceZonesStep: import("@medusajs/framework/workflows-sdk").StepFunction<CreateServiceZoneDTO[], import("@medusajs/framework/types").ServiceZoneDTO[]>;
