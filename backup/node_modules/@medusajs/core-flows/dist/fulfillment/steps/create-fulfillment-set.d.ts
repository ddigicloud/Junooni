 ...
 */
export declare const createFulfillmentSets: import("@medusajs/framework/workflows-sdk").StepFunction<CreateFulfillmentSetDTO[], import("@medusajs/framework/types").FulfillmentSetDTO[]>;
