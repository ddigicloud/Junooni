 ...
 */
export declare const calculateShippingOptionsPricesStep: import("@medusajs/framework/workflows-sdk").StepFunction<CalculateShippingOptionPriceDTO[], import("@medusajs/framework/types").CalculatedShippingOptionPrice[]>;
