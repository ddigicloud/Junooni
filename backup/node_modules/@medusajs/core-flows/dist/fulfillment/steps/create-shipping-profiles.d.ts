 ...
 */
export declare const createShippingProfilesStep: import("@medusajs/framework/workflows-sdk").StepFunction<CreateShippingProfileDTO[], import("@medusajs/framework/types").ShippingProfileDTO[]>;
