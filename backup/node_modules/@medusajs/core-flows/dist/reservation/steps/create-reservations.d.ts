 ...
 */
export declare const createReservationsStep: import("@medusajs/framework/workflows-sdk").StepFunction<InventoryTypes.CreateReservationItemInput[], InventoryTypes.ReservationItemDTO[]>;
