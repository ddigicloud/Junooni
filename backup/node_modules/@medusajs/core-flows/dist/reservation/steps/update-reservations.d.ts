 ...
 */
export declare const updateReservationsStep: import("@medusajs/framework/workflows-sdk").StepFunction<InventoryTypes.UpdateReservationItemInput[], InventoryTypes.ReservationItemDTO[]>;
