 ...
 */
export declare const createCustomerGroupsStep: import("@medusajs/framework/workflows-sdk").StepFunction<CreateCustomerGroupDTO[], import("@medusajs/framework/types").CustomerGroupDTO[]>;
