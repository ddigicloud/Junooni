 ...
 */
export declare const updateCartsStep: import("@medusajs/framework/workflows-sdk").StepFunction<UpdateCartWorkflowInputDTO[], import("@medusajs/framework/types").CartDTO[]>;
