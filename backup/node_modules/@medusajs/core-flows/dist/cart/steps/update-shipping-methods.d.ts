 ...
 */
export declare const updateShippingMethodsStep: import("@medusajs/framework/workflows-sdk").StepFunction<UpdateShippingMethodDTO[], import("@medusajs/framework/types").CartShippingMethodDTO[]>;
