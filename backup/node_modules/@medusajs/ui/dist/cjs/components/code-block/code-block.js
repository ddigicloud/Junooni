...
// @ts-ignore
Promise.resolve().then(() => tslib_1.__importStar(require("prismjs/components/prism-json")));
...
snippets, className, children, ...props }) => {
    ...
    return (React.createElement(CodeBlockContext.Provider, { value: { snippets, active, setActive } },
        React.createElement("div", { className: (0, clx_1.clx)("bg-ui-contrast-bg-base shadow-elevation-code-block flex flex-col overflow-hidden rounded-xl", className), ...props }, children)));
};
...
hideLabels = false, ...props }) => {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { className: (0, clx_1.clx)("flex items-start px-4 pt-2.5", className), ...props },
            !hideLabels &&
                snippets.map((snippet, idx) => (React.createElement("div", { className: (0, clx_1.clx)("text-ui-contrast-fg-secondary txt-compact-small-plus transition-fg relative cursor-pointer pb-[9px] pr-3", {
        ...
        React.createElement("div", { className: "w-full px-0.5" },
            React.createElement("div", { className: "bg-ui-contrast-border-top relative h-px w-full" },
                React.createElement("div", { ref: tabIndicatorRef, className: (0, clx_1.clx)("absolute bottom-0 transition-all motion-reduce:transition-none", "duration-150 ease-linear") },
...
const Meta = ({ className, ...props }) => {
    return (React.createElement("div", { className: (0, clx_1.clx)("txt-compact-small text-ui-contrast-fg-secondary ml-auto", className), ...props }));
};
...
const Body = ({ className, children, ...props }) => {
    ...
    return (React.createElement("div", null,
        showToolbar && (React.createElement("div", { className: "border-ui-contrast-border-bot flex min-h-10 items-center gap-x-3 border-t px-4 py-2" },
            ...
            !active.hideCopy && (React.createElement(copy_1.Copy, { content: active.code, className: "text-ui-contrast-fg-secondary" })))),
        React.createElement("div", { className: "flex h-full flex-col overflow-hidden px-[5px] pb-[5px]" },
            React.createElement("div", { className: (0, clx_1.clx)("bg-ui-contrast-bg-subtle border-ui-contrast-border-bot relative h-full overflow-y-auto rounded-lg border p-4", className), ...props },
