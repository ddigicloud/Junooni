import { EventBusTypes, InternalModuleDeclaration, MedusaContainer } from "@medusajs/types";
export declare abstract class AbstractEventBusModuleService implements EventBusTypes.IEventBusModuleService {
    ...
    protected constructor(container: MedusaContainer, moduleOptions: {} | undefined, moduleDeclaration: InternalModuleDeclaration);
