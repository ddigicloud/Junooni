...
export declare class AbstractFulfillmentProviderService implements IFulfillmentProvider {
     ...
     * }
     */
    calculatePrice(optionData: Record<string, unknown>, data: Record<string, unknown>, context: Record<string, unknown>): Promise<number>;
    /**
     ...
     * }
     */
    createFulfillment(data: object, items: object[], order: object | undefined, fulfillment: Record<string, unknown>): Promise<any>;
    /**
