...
import "./chunk-NKCQHNOW.mjs";
import {
  ConditionalTooltip
} from "./chunk-OC7BQLYI.mjs";
import {
  languages
} from "./chunk-4LB7WM5Y.mjs";
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-list-NXRVL3AS.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./product-create-M74LHBX2.mjs")
                  },
                  {
                    path: "import",
                    lazy: () => import("./product-import-7GGVLKVP.mjs")
                  },
                  {
                    path: "export",
                    lazy: () => import("./product-export-GKFK3V6O.mjs")
                  }
                ]
              },
              {
                ...
                errorElement: /* @__PURE__ */ jsx17(ErrorBoundary, {}),
                lazy: async () => {
                  const { Breadcrumb, loader } = await import("./product-detail-VWUYKM42.mjs");
                  return {
                    Component: Outlet4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./product-detail-VWUYKM42.mjs"),
                    children: [
                      {
                        path: "edit",
                        lazy: () => import("./product-edit-M5QRYSIN.mjs")
                      },
                      {
                        path: "edit-variant",
                        lazy: () => import("./product-variant-edit-2BHGXUA6.mjs")
                      },
                      {
                        path: "sales-channels",
                        lazy: () => import("./product-sales-channels-PT5COS5U.mjs")
                      },
                      {
                        path: "attributes",
                        lazy: () => import("./product-attributes-3X2ML7HD.mjs")
                      },
                      {
                        path: "organization",
                        lazy: () => import("./product-organization-M4PEZIDW.mjs")
                      },
                      {
                        path: "media",
                        lazy: () => import("./product-media-UIB62VI2.mjs")
                      },
                      {
                        path: "prices",
                        lazy: () => import("./product-prices-46FQJHS4.mjs")
                      },
                      {
                        path: "options/create",
                        lazy: () => import("./product-create-option-IA635PSX.mjs")
                      },
                      {
                        path: "options/:option_id/edit",
                        lazy: () => import("./product-edit-option-ETDFQLHI.mjs")
                      },
                      {
                        path: "variants/create",
                        lazy: () => import("./product-create-variant-VM4JQNLU.mjs")
                      },
                      {
                        path: "metadata/edit",
                        lazy: () => import("./product-metadata-XR7TK52Z.mjs")
                      }
                    ]
                  },
                  {
                    ...
                    lazy: async () => {
                      const { Component, Breadcrumb, loader } = await import("./product-variant-detail-OZRHNBDR.mjs");
                      return {
                        Component,
                        loader,
                        handle: {
                    ...
                    children: [
                      ...
                      {
                        path: "manage-items",
                        lazy: () => import("./product-variant-manage-inventory-items-VQNU6PPR.mjs")
                      },
                      {
                        path: "metadata/edit",
                        lazy: () => import("./product-variant-metadata-IAI7TFHF.mjs")
                      }
                    ]
                  }
                ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./category-list-K2FLP6YO.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./category-create-ZITED2BA.mjs")
                  },
                  {
                    path: "organize",
                    lazy: () => import("./category-organize-STPIJ7H5.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./category-detail-3HYXSHYY.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./category-edit-EYS2WVEP.mjs")
                  },
                  {
                    path: "products",
                    lazy: () => import("./category-products-XC6QCC3Z.mjs")
                  },
                  {
                    path: "organize",
                    lazy: () => import("./category-organize-STPIJ7H5.mjs")
                  ...
                  {
                    path: "metadata/edit",
                    lazy: () => import("./categories-metadata-IBMVVJLZ.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./order-list-GMTSPGRC.mjs")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./order-detail-JGQUTQOS.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "fulfillment",
                    lazy: () => import("./order-create-fulfillment-Y3TYOSIH.mjs")
                  },
                  {
                    path: "returns/:return_id/receive",
                    lazy: () => import("./order-receive-return-DTPABCQD.mjs")
                  },
                  {
                    path: "allocate-items",
                    lazy: () => import("./order-allocate-items-GN735OMU.mjs")
                  },
                  {
                    path: ":f_id/create-shipment",
                    lazy: () => import("./order-create-shipment-FTQ3M5DY.mjs")
                  },
                  {
                    path: "returns",
                    lazy: () => import("./order-create-return-X2GZ26W4.mjs")
                  },
                  {
                    path: "claims",
                    lazy: () => import("./order-create-claim-A7ZYSJOL.mjs")
                  },
                  {
                    path: "exchanges",
                    lazy: () => import("./order-create-exchange-VFVYCU6U.mjs")
                  },
                  {
                    path: "edits",
                    lazy: () => import("./order-create-edit-NU6MBMMB.mjs")
                  },
                  {
                    path: "refund",
                    lazy: () => import("./order-create-refund-J6SDO2LT.mjs")
                  },
                  {
                    path: "transfer",
                    lazy: () => import("./order-request-transfer-X6HJHBY2.mjs")
                  },
                  {
                    path: "email",
                    lazy: () => import("./order-edit-email-3WUCGTBG.mjs")
                  },
                  {
                    path: "shipping-address",
                    lazy: () => import("./order-edit-shipping-address-ZTYIQNRA.mjs")
                  },
                  {
                    path: "billing-address",
                    lazy: () => import("./order-edit-billing-address-O4MTFSRR.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./promotion-list-HLTCM67I.mjs")
              },
              {
                path: "create",
                lazy: () => import("./promotion-create-J6AGJF7A.mjs")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./promotion-detail-KDFGR7BZ.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./promotion-edit-details-B4KOIWKE.mjs")
                  },
                  {
                    path: "add-to-campaign",
                    lazy: () => import("./promotion-add-campaign-25TIN5IB.mjs")
                  },
                  {
                    path: ":ruleType/edit",
                    lazy: () => import("./edit-rules-B6UDGQUG.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./campaign-list-64JKP7BK.mjs"),
                children: []
              },
              {
                path: "create",
                lazy: () => import("./campaign-create-OAKYLGSZ.mjs")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./campaign-detail-SARFWXWT.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./campaign-edit-GOOVVHII.mjs")
                  },
                  {
                    path: "configuration",
                    lazy: () => import("./campaign-configuration-VKTEKN23.mjs")
                  },
                  {
                    path: "edit-budget",
                    lazy: () => import("./campaign-budget-edit-2JP6PEXM.mjs")
                  },
                  {
                    path: "add-promotions",
                    lazy: () => import("./add-campaign-promotions-EX7KIY5W.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./collection-list-3WHASOL7.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./collection-create-XWJWYZIM.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./collection-detail-SCGBBPM2.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./collection-edit-RS7HGQPQ.mjs")
                  },
                  {
                    path: "products",
                    lazy: () => import("./collection-add-products-AEMVIJOL.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./price-list-list-7XVEGYCI.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./price-list-create-UDCPT7DP.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./price-list-detail-5X3IRPFF.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./price-list-edit-VF4LJIG6.mjs")
                  },
                  {
                    path: "configuration",
                    lazy: () => import("./price-list-configuration-OHWYBDDE.mjs")
                  },
                  {
                    path: "products/add",
                    lazy: () => import("./price-list-prices-add-R7H6AJDS.mjs")
                  },
                  {
                    path: "products/edit",
                    lazy: () => import("./price-list-prices-edit-SD3NA3VR.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./customer-list-IEE2VMYO.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./customer-create-QF5MYXCD.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./customer-detail-6ZML2AZL.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./customer-edit-LMQUOCTA.mjs")
                  },
                  {
                    path: "add-customer-groups",
                    lazy: () => import("./customers-add-customer-group-OFEZYG4F.mjs")
                  },
                  {
                  ...
                  {
                    path: "metadata/edit",
                    lazy: () => import("./customer-metadata-S3XQ2KFD.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./customer-group-list-O2KV2XY5.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./customer-group-create-HJ2EYTEE.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./customer-group-detail-6E2T7S5Z.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./customer-group-edit-FHHDHYSX.mjs")
                  },
                  {
                    path: "add-customers",
                    lazy: () => import("./customer-group-add-customers-IJTSR3VY.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./customer-group-metadata-ITGDASAY.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./reservation-list-NG6Q6IZU.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./reservation-create-V5ZP4LWX.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./reservation-detail-VEJCADD5.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./edit-reservation-O4734SWG.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./reservation-metadata-76KHKBEG.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./inventory-list-RSWA3JU6.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./inventory-create-B5XNALJC.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./inventory-detail-K7HHQC42.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./edit-inventory-item-KRIDX33V.mjs")
                  },
                  {
                    path: "attributes",
                    lazy: () => import("./edit-inventory-item-attributes-ZOJQXYJ5.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./inventory-metadata-UGKSZRS5.mjs")
                  },
                  {
                    path: "locations",
                    lazy: () => import("./manage-locations-TSB2HIGF.mjs")
                  },
                  {
                    path: "locations/:location_id",
                    lazy: () => import("./adjust-inventory-2DGMUCJD.mjs")
                  }
                ]
              }
            ]
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            path: "profile",
            errorElement: /* @__PURE__ */ jsx17(ErrorBoundary, {}),
            lazy: () => import("./profile-detail-6IKKIODU.mjs"),
            handle: {
            ...
            children: [
              {
                path: "edit",
                lazy: () => import("./profile-edit-J64BWKCP.mjs")
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./region-list-PKTSD4XO.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./region-create-MX2XOBVW.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./region-detail-2X2CE535.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./region-edit-YLQLP5BJ.mjs")
                  },
                  {
                    path: "countries/add",
                    lazy: () => import("./region-add-countries-AULECM5W.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./region-metadata-3RLMBQKC.mjs")
                  }
                ]
              }
            ]
          },
          {
            path: "store",
            errorElement: /* @__PURE__ */ jsx17(ErrorBoundary, {}),
            lazy: () => import("./store-detail-4I3WWL4W.mjs"),
            handle: {
            ...
            children: [
              {
                path: "edit",
                lazy: () => import("./store-edit-NDU4YN6A.mjs")
              },
              {
                path: "currencies",
                lazy: () => import("./store-add-currencies-RTKGNQVB.mjs")
              },
              {
                path: "metadata/edit",
                lazy: () => import("./store-metadata-7LZNDGQ3.mjs")
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./user-list-B3ERFGPV.mjs"),
                children: [
                  {
                    path: "invite",
                    lazy: () => import("./user-invite-CKWNLELC.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./user-detail-TK3U5EBX.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  ...
                  {
                    path: "metadata/edit",
                    lazy: () => import("./user-metadata-XBIRRZ3B.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./sales-channel-list-H3AUKTNH.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./sales-channel-create-OK5DGIIN.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./sales-channel-detail-SFPAILCG.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./sales-channel-edit-MVUEY2TU.mjs")
                  },
                  {
                    path: "add-products",
                    lazy: () => import("./sales-channel-add-products-PXVDDFHZ.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./sales-channel-metadata-XGAHANIJ.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./location-list-4X4KXJ2H.mjs")
              },
              {
                path: "create",
              ...
              },
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./shipping-profiles-list-6Z2AVQMQ.mjs"),
                    children: [
                      {
                        path: "create",
                  ...
                  },
                  {
                    ...
                    lazy: async () => {
                      const { Component, Breadcrumb, loader } = await import("./shipping-profile-detail-F7DKLKFD.mjs");
                      return {
                        Component,
                        loader,
                        handle: {
                    ...
                    children: [
                      {
                        path: "metadata/edit",
                        lazy: () => import("./shipping-profile-metadata-BPHDDHIO.mjs")
                      }
                    ]
                  }
                ]
              },
              {
                path: ":location_id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./location-detail-5WKZRAFO.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  ...
                  {
                    path: "sales-channels",
                    lazy: () => import("./location-sales-channels-XXLRURXR.mjs")
                  },
                  {
                    path: "fulfillment-providers",
                    lazy: () => import("./location-fulfillment-providers-JMUK2NWS.mjs")
                  },
                  {
                    ...
                    children: [
                      {
                        ...
                        lazy: () => import("./location-service-zone-create-3VZEA27Y.mjs")
                      },
                      {
                        ...
                        children: [
                          ...
                          {
                            path: "areas",
                            lazy: () => import("./location-service-zone-manage-areas-FG2RW4RX.mjs")
                          },
                          {
                            ...
                            children: [
                              {
                                path: "create",
                                lazy: () => import("./location-service-zone-shipping-option-create-22NC673T.mjs")
                              },
                              {
                                path: ":so_id",
                                children: [
                                  ...
                                  {
                                    path: "pricing",
                                    lazy: () => import("./location-service-zone-shipping-option-pricing-KPK4XJUO.mjs")
                                  }
                                ]
                              }
                            ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-tag-list-26WRLGFB.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./product-tag-create-U7N6CJNH.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./product-tag-detail-HF4ITMTE.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./product-tag-edit-5NH7WH4F.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./workflow-execution-list-RREQ74UC.mjs")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./workflow-execution-detail-GIUBNIP4.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-type-list-KN62A6SF.mjs"),
                children: [
                  {
                    path: "create",
              ...
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./product-type-detail-RHMYQXKM.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
            ...
            children: [
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./api-key-management-list-WWSKKJX2.mjs"),
                    children: [
                      {
                        path: "create",
                        lazy: () => import("./api-key-management-create-MMWMR3Q7.mjs")
                      }
                    ]
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./api-key-management-detail-DTHLCTXM.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./api-key-management-edit-ROC5TSPX.mjs")
                  },
                  {
                    path: "sales-channels",
                    lazy: () => import("./api-key-management-sales-channels-UPPRHMPL.mjs")
                  }
                ]
              }
            ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./tax-region-list-3S3JQJDK.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./tax-region-create-JF5NFQM4.mjs")
                  }
                ]
              },
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: async () => {
                      const { Component } = await import("./tax-region-detail-6YKGQK7H.mjs");
                      return {
                        Component
                      };
                    },
                    children: [
                      ...
                      },
                      {
                        ...
                        lazy: () => import("./tax-region-tax-override-create-GD7P5XWL.mjs")
                      },
                      {
                        path: "overrides/:tax_rate_id/edit",
                        lazy: () => import("./tax-region-tax-override-edit-U37CZ2KV.mjs")
                      },
                      {
                  ...
                  },
                  {
                    ...
                    lazy: async () => {
                      const { Component, Breadcrumb, loader } = await import("./tax-region-province-detail-6TI26GZF.mjs");
                      return {
                        Component,
                        loader,
                        handle: {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./return-reason-list-3CTUZJKL.mjs"),
                children: [
                  {
                    path: "create",
    ...
    children: [
      {
        ...
        children: [
          {
            path: "/login",
            lazy: () => import("./login-OCJLG554.mjs")
          },
          {
            path: "/reset-password",
            lazy: () => import("./reset-password-7VNGPKZV.mjs")
          },
          {
            path: "/invite",
