...
var Total = ({
  ...
  return /* @__PURE__ */ jsxs2("div", { children: [
    ...
    totalPending > 0 && /* @__PURE__ */ jsxs2("div", { className: "flex items-center justify-between px-6 py-4", children: [
      /* @__PURE__ */ jsx2(Text, { size: "small", weight: "plus", leading: "compact", children: "Total pending" }),
      /* @__PURE__ */ jsx2(Text, { size: "small", weight: "plus", leading: "compact", children: getStylizedAmount(totalPending, currencyCode) })
    ] })
  ] });
};
