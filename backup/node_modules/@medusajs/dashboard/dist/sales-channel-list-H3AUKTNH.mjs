...
var SalesChannelListTable = () => {
  ...
  const sales_channels_data = sales_channels?.map((sales_channel) => {
    sales_channel.is_default = store?.default_sales_channel_id === sales_channel.id;
...
var SalesChannelActions = ({
  ...
  const disabledTooltip = salesChannel.is_default ? t("salesChannels.tooltip.cannotDeleteDefault") : void 0;
  const groups = [
    {
      actions: [
        {
  ...
  return /* @__PURE__ */ jsx(ActionMenu, { groups });
};
