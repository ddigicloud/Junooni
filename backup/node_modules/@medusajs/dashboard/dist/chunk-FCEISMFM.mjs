...
var Accordion = React.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx2(Collection.Provider, { scope: props.__scopeAccordion, children: type === "multiple" ? /* @__PURE__ */ jsx2(AccordionImplMultiple, { ...multipleProps, ref: forwardedRef }) : /* @__PURE__ */ jsx2(AccordionImplSingle, { ...singleProps, ref: forwardedRef }) });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx2(
      AccordionValueProvider,
      {
        ...
        children: /* @__PURE__ */ jsx2(AccordionCollapsibleProvider, { scope: props.__scopeAccordion, collapsible, children: /* @__PURE__ */ jsx2(AccordionImpl, { ...accordionSingleProps, ref: forwardedRef }) })
      }
    );
  }
);
var AccordionImplMultiple = React.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx2(
    AccordionValueProvider,
    {
      ...
      children: /* @__PURE__ */ jsx2(AccordionCollapsibleProvider, { scope: props.__scopeAccordion, collapsible: true, children: /* @__PURE__ */ jsx2(AccordionImpl, { ...accordionMultipleProps, ref: forwardedRef }) })
    }
  );
});
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx2(
      AccordionImplProvider,
      {
        ...
        direction: dir,
        orientation,
        children: /* @__PURE__ */ jsx2(Collection.Slot, { scope: __scopeAccordion, children: /* @__PURE__ */ jsx2(
          Primitive.div,
          {
            ...accordionProps,
...
var AccordionTrigger = React.forwardRef(
  (props, forwardedRef) => {
    ...
    const collapsibleScope = useCollapsibleScope(__scopeAccordion);
    return /* @__PURE__ */ jsx2(Collection.ItemSlot, { scope: __scopeAccordion, children: /* @__PURE__ */ jsx2(
...
var ConditionalPriceForm = ({
  ...
  return /* @__PURE__ */ jsx3(Form, { ...conditionalPriceForm, children: /* @__PURE__ */ jsx3(
    KeyboundForm,
    {
      ...
      children: /* @__PURE__ */ jsxs(StackedFocusModal.Content, { children: [
        /* @__PURE__ */ jsx3(StackedFocusModal.Header, {}),
        /* @__PURE__ */ jsx3(StackedFocusModal.Body, { className: "size-full overflow-hidden", children: /* @__PURE__ */ jsx3("div", { className: "flex size-full flex-1 flex-col items-center overflow-y-auto", children: /* @__PURE__ */ jsx3("div", { className: "flex w-full max-w-[720px] flex-col gap-y-8 px-6 py-16", children: /* @__PURE__ */ jsxs("div", { className: "flex w-full flex-col gap-y-6", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx3(StackedFocusModal.Title, { asChild: true, children: /* @__PURE__ */ jsx3(Heading, { children: t2(
              "stockLocations.shippingOptions.conditionalPrices.header",
              {
                name: header
              }
            ) }) }),
            /* @__PURE__ */ jsx3(StackedFocusModal.Description, { asChild: true, children: /* @__PURE__ */ jsx3(Text, { size: "small", className: "text-ui-fg-subtle", children: t2(
              "stockLocations.shippingOptions.conditionalPrices.description"
            ) }) })
          ] }),
          /* @__PURE__ */ jsx3(ConditionalPriceList, { value, onValueChange: setValue, children: fields.map((field2, index) => /* @__PURE__ */ jsx3(
          ...
          /* @__PURE__ */ jsx3("div", { className: "flex items-center justify-end", children: /* @__PURE__ */ jsx3(
            Button,
            {
              variant: "secondary",
              size: "small",
        ...
        /* @__PURE__ */ jsx3(StackedFocusModal.Footer, { children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-2", children: [
          /* @__PURE__ */ jsx3(StackedFocusModal.Close, { asChild: true, children: /* @__PURE__ */ jsx3(Button, { variant: "secondary", size: "small", type: "button", children: t2("actions.cancel") }) }),
          /* @__PURE__ */ jsx3(Button, { size: "small", type: "button", onClick: handleOnSubmit, children: t2("actions.save") })
        ] }) })
      ] })
    }
  ) });
...
var ConditionalPriceItem = ({
  ...
  return /* @__PURE__ */ jsxs(
    Item,
    {
      ...
      children: [
        /* @__PURE__ */ jsx3(Trigger2, { asChild: true, children: /* @__PURE__ */ jsxs("div", { className: "group/trigger flex w-full cursor-pointer items-start justify-between gap-x-2 p-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-wrap items-center justify-between gap-2", children: [
            /* @__PURE__ */ jsx3("div", { className: "flex h-7 items-center", children: /* @__PURE__ */ jsx3(
              AmountDisplay,
              {
                index,
                currency,
            ...
            /* @__PURE__ */ jsx3("div", { className: "flex min-h-7 items-center", children: /* @__PURE__ */ jsx3(
              ConditionDisplay,
              {
                index,
                currency,
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-2", children: [
            ...
            /* @__PURE__ */ jsx3(
              IconButton,
              {
                ...
                variant: "transparent",
                className: "text-ui-fg-muted hover:text-ui-fg-subtle focus-visible:text-ui-fg-subtle",
                children: /* @__PURE__ */ jsx3(TriangleDownMini, { className: "transition-transform group-data-[state=open]/trigger:rotate-180" })
              }
            )
          ] })
        ] }) }),
        /* @__PURE__ */ jsxs(Content2, { className: "text-ui-fg-subtle", children: [
          ...
          /* @__PURE__ */ jsx3(
            Form.Field,
            {
              ...
              render: ({ field: { value, onChange, ...props } }) => {
                return /* @__PURE__ */ jsx3(Form.Item, { children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 items-start gap-x-2 p-3", children: [
                  /* @__PURE__ */ jsx3("div", { className: "flex h-8 items-center", children: /* @__PURE__ */ jsx3(Form.Label, { children: t2(
...
var OperatorInput = ({
  ...
  return /* @__PURE__ */ jsx3(Form.Item, { children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 items-start gap-x-2 p-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex h-8 items-center gap-x-1", children: [
      /* @__PURE__ */ jsx3(IconButton, { size: "2xsmall", variant: "transparent", onClick: action, children: isNull ? /* @__PURE__ */ jsx3(Plus, {}) : /* @__PURE__ */ jsx3(XMark, {}) }),
...
var ReadOnlyConditions = ({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-1 px-3 pt-3", children: [
      /* @__PURE__ */ jsx3(Text, { size: "small", leading: "compact", weight: "plus", children: t2(
      ...
      /* @__PURE__ */ jsx3(
        Tooltip,
        {
          ...
          children: /* @__PURE__ */ jsx3(InformationCircleSolid, { className: "text-ui-fg-muted" })
        }
      )
    ] }),
    /* @__PURE__ */ jsxs("div", { children: [
      item.eq != null && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 items-start gap-x-2 p-3", children: [
        /* @__PURE__ */ jsx3("div", { className: "flex h-8 items-center", children: /* @__PURE__ */ jsx3(Label, { weight: "plus", size: "small", children: t2(
...
var AmountDisplay = ({
  ...
  if (amount === "" || amount === void 0) {
    return /* @__PURE__ */ jsx3(Text, { size: "small", weight: "plus", children: "-" });
  }
  const castAmount = castNumber(amount);
  return /* @__PURE__ */ jsx3(Text, { size: "small", weight: "plus", children: getLocaleAmount(castAmount, currency.code) });
};
      ...
      return /* @__PURE__ */ jsx3(ConditionContainer, { children: /* @__PURE__ */ jsx3(
        Trans,
        {
          ...
          components: [
            ...
            /* @__PURE__ */ jsx3(Badge, { size: "2xsmall" }, "gte")
          ],
          values: {
            attribute: t2(
    ...
    if (!castGte && castLte) {
      return /* @__PURE__ */ jsx3(ConditionContainer, { children: /* @__PURE__ */ jsx3(
        Trans,
        {
          ...
          components: [
            /* @__PURE__ */ jsx3(Badge, { size: "2xsmall" }, "attribute"),
            /* @__PURE__ */ jsx3(Badge, { size: "2xsmall" }, "lte")
          ],
          values: {
            attribute: t2(
              "stockLocations.shippingOptions.conditionalPrices.attributes.cartItemTotal"
...
var OuterComponent = ({
  ...
  return /* @__PURE__ */ jsxs2(
    "div",
    {
      ...
      children: [
        price?.length > 0 && !isAnchor && /* @__PURE__ */ jsx4("div", { className: "flex size-[15px] items-center justify-center group-hover/container:hidden", children: /* @__PURE__ */ jsx4(CircleSliders, { className: "text-ui-fg-interactive" }) }),
        /* @__PURE__ */ jsx4(
          "button",
          {
            ref: buttonRef,
            ...
            children: /* @__PURE__ */ jsx4(ArrowsPointingOut, {})
          }
        )
      ]
    }
  ...
  return useMemo(() => {
    return [
      columnHelper.column({
        ...
        cell: (context) => {
          return /* @__PURE__ */ jsx5(DataGrid.ReadonlyCell, { context, children: name });
        }
      }),
  ...
  return [
    ...currencies2?.map((currency) => {
      ...
      return columnHelper2.column({
        ...
        header: () => /* @__PURE__ */ jsxs3("div", { className: "flex w-full items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsx5("span", { className: "truncate", title: translatedCurrencyName, children: translatedCurrencyName }),
          /* @__PURE__ */ jsx5(IncludesTaxTooltip, { includesTax: preference?.is_tax_inclusive })
        ] }),
        cell: (context) => {
    ...
    ...regions?.map((region) => {
      ...
      return columnHelper2.column({
        ...
        type: "number",
        header: () => /* @__PURE__ */ jsxs3("div", { className: "flex w-full items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsx5("span", { className: "truncate", title: translatedRegionName, children: translatedRegionName }),
          /* @__PURE__ */ jsx5(IncludesTaxTooltip, { includesTax: preference?.is_tax_inclusive })
        ] }),
        cell: (context) => {
