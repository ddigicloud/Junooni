...
import {
  ActionMenu
} from "./chunk-NKCQHNOW.mjs";
import "./chunk-OC7BQLYI.mjs";
import "./chunk-C76H5USB.mjs";
import "./chunk-FZFMTVUS.mjs";
...
import "./chunk-4LB7WM5Y.mjs";
import "./chunk-LJQNRGKD.mjs";
import "./chunk-CC5Y5H6V.mjs";
...
var ApiKeyGeneralSection = ({ apiKey }) => {
  ...
  return /* @__PURE__ */ jsxs(Container, { className: "divide-y p-0", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "text-ui-fg-subtle grid grid-cols-2 items-center px-6 py-4", children: [
      ...
      apiKey.type === "secret" ? /* @__PURE__ */ jsx(Badge, { size: "2xsmall", children: prettifyRedactedToken(apiKey.redacted) }) : /* @__PURE__ */ jsx(Copy, { asChild: true, content: apiKey.token, className: "cursor-pointer", children: /* @__PURE__ */ jsx(Badge, { size: "2xsmall", className: "text-ui-tag-neutral-text", children: prettifyRedactedToken(apiKey.redacted) }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "text-ui-fg-subtle grid grid-cols-2 items-center px-6 py-4", children: [
...
var ApiKeySalesChannelSection = ({
  ...
  return /* @__PURE__ */ jsxs2(Container2, { className: "divide-y p-0", children: [
    /* @__PURE__ */ jsxs2("div", { className: "flex items-center justify-between px-6 py-4", children: [
      /* @__PURE__ */ jsx2(Heading2, { level: "h2", children: t("salesChannels.domain") }),
      /* @__PURE__ */ jsx2(
        ActionMenu,
        {
          groups: [
    ...
    () => [
      ...
      columnHelper.display({
        ...
        cell: ({ row, table }) => {
          ...
          return /* @__PURE__ */ jsx2(SalesChannelActions, { salesChannel: row.original, apiKey });
        }
      })
    ],
    [base]
