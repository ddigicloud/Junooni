...
exports.adminPaymentRoutesMiddlewares = [
    ...
    },
    {
        ...
        middlewares: [
            (0, http_1.unlessPath)(/.*\/payments\/payment-providers/, (0, framework_1.validateAndTransformQuery)(validators_1.AdminGetPaymentParams, queryConfig.retrieveTransformQueryConfig)),
        ],
    },
    {
        method: ["POST"],
