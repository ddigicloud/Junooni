...
var TagName = "div";
var useCollection = _6TI3NXX6cjs.createHook.call(void 0, 
  function useCollection2(_a) {
    var _b = _a, { store } = _b, props = _7EQBAZ46cjs.__objRest.call(void 0, _b, ["store"]);
    const context = _FVVTEJ4Kcjs.useCollectionProviderContext.call(void 0, );
    store = store || context;
    props = _L5A2ID7Scjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _FVVTEJ4Kcjs.CollectionScopedContextProvider, { value: store, children: element }),
      [store]
    );
    return _misc.removeUndefinedValues.call(void 0, props);
  }
);
var Collection = _6TI3NXX6cjs.forwardRef.call(void 0, function Collection2(props) {
