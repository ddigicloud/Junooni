...
var useForm = _6TI3NXX6cjs.createHook.call(void 0, function useForm2(_a) {
  var _b = _a, {
    store,
  ...
  const defaultValues = _L5A2ID7Scjs.useInitialValue.call(void 0, values);
  ...
  const onSubmit = _L5A2ID7Scjs.useEvent.call(void 0, (event) => {
  ...
  const onReset = _L5A2ID7Scjs.useEvent.call(void 0, (event) => {
  ...
  props = _L5A2ID7Scjs.useWrapElement.call(void 0, 
    props,
    (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _ZCS6RONRcjs.FormScopedContextProvider, { value: store, children: element }),
    [store]
  );
...
var Form = _6TI3NXX6cjs.forwardRef.call(void 0, function Form2(props) {
