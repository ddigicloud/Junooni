...
var _7CIOCRZDcjs = require('../__chunks/7CIOCRZD.cjs');


var _BB77FAWKcjs = require('../__chunks/BB77FAWK.cjs');
...
function useComboboxItemOffscreen(_a) {
  ...
  store = store || context;
  const offscreenProps = _BB77FAWKcjs.useCompositeItemOffscreen.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store, value }, props));
...
var ComboboxItem2 = _6TI3NXX6cjs.forwardRef.call(void 0, function ComboboxItem3(_a) {
  var _b = _a, {
    offscreenBehavior,
    offscreenRoot
  ...
  if (active) {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _7CIOCRZDcjs.ComboboxItem, _7EQBAZ46cjs.__spreadValues.call(void 0, {}, allProps));
  }
  const _b2 = allProps, {
    store,
    value,
