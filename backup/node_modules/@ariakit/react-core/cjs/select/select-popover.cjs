...
var _XPETY6KQcjs = require('../__chunks/XPETY6KQ.cjs');
require('../__chunks/ZBFMPPGZ.cjs');


var _QZEXWZZZcjs = require('../__chunks/QZEXWZZZ.cjs');
...
var _3DQRN2JUcjs = require('../__chunks/3DQRN2JU.cjs');
...
var TagName = "div";
var useSelectPopover = _6TI3NXX6cjs.createHook.call(void 0, 
  function useSelectPopover2(_a) {
    ...
    const context = _QZEXWZZZcjs.useSelectProviderContext.call(void 0, );
    store = store || context;
    props = _XPETY6KQcjs.useSelectList.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store, alwaysVisible }, props));
    props = _3DQRN2JUcjs.usePopover.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store, alwaysVisible }, props));
    return props;
  }
);
var SelectPopover = _26CLTSY6cjs.createDialogComponent.call(void 0, 
  _6TI3NXX6cjs.forwardRef.call(void 0, function SelectPopover2(props) {
    const htmlProps = useSelectPopover(props);
    return _6TI3NXX6cjs.createElement.call(void 0, TagName, htmlProps);
  }),
  _QZEXWZZZcjs.useSelectProviderContext
);
