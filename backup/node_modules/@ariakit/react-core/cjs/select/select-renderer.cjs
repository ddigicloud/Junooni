...
var _PWR4OSNCcjs = require('../__chunks/PWR4OSNC.cjs');



var _4WTKUZTYcjs = require('../__chunks/4WTKUZTY.cjs');
...
function useSelectRenderer(_a) {
  ...
  return _PWR4OSNCcjs.useCompositeRenderer.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
    store,
    items,
    persistentIndices
  }, props));
...
exports.SelectRenderer = SelectRenderer; exports.getSelectRendererItem = _4WTKUZTYcjs.getCollectionRendererItem; exports.getSelectRendererItemId = _4WTKUZTYcjs.getCollectionRendererItemId;
