...
var _CELUF47Pcjs = require('../__chunks/CELUF47P.cjs');
require('../__chunks/SQHULPZ2.cjs');
...
function SelectProvider(props = {}) {
  const store = _CELUF47Pcjs.useSelectStore.call(void 0, props);
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _QZEXWZZZcjs.SelectContextProvider, { value: store, children: props.children });
}
