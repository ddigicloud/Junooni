...
var _GJ42LWUCcjs = require('./GJ42LWUC.cjs');



var _CLOVACVYcjs = require('./CLOVACVY.cjs');
...
var _5ENGRSQKcjs = require('./5ENGRSQK.cjs');
...
var _2WZY5KXBcjs = require('./2WZY5KXB.cjs');



var _53NM5U3Acjs = require('./53NM5U3A.cjs');
...
var _KYD66ZXYcjs = require('./KYD66ZXY.cjs');
...
var useDialog = _6TI3NXX6cjs.createHook.call(void 0, function useDialog2(_a) {
  ...
  const hidden = _53NM5U3Acjs.isHidden.call(void 0, mounted, props.hidden, props.alwaysVisible);
  _UWFFCHQUcjs.usePreventBodyScroll.call(void 0, contentElement, id, preventBodyScroll && !hidden);
  _5ENGRSQKcjs.useHideOnInteractOutside.call(void 0, store, hideOnInteractOutside, domReady);
  ...
  _L5A2ID7Scjs.useSafeLayoutEffect.call(void 0, () => {
    ...
    const dialog = ref.current;
    if (!dialog) return;
    return _CLOVACVYcjs.disableTree.call(void 0, dialog);
  ...
  _L5A2ID7Scjs.useSafeLayoutEffect.call(void 0, () => {
    ...
    if (modal) {
      return _misc.chain.call(void 0, 
        ...
        _CLOVACVYcjs.disableTreeOutside.call(void 0, id, allElements)
      );
    }
  ...
  props = _53NM5U3Acjs.useDisclosureContent.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store }, props));
  props = _KYD66ZXYcjs.useFocusable.call(void 0, _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {}, props), { focusable }));
  props = _2WZY5KXBcjs.usePortal.call(void 0, _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { portal }, props), { portalRef, preserveTabOrder }));
  return props;
});
