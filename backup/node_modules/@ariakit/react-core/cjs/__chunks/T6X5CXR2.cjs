...
var _JLUMKCNRcjs = require('./JLUMKCNR.cjs');
...
var useMenuList = _6TI3NXX6cjs.createHook.call(void 0, 
  function useMenuList2(_a) {
    ...
    props = _L5A2ID7Scjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _JLUMKCNRcjs.MenuScopedContextProvider, { value: store, children: element }),
      [store]
    );
    ...
    props = _JDIXK252cjs.useComposite.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store, composite }, props));
