...
function useMenubarStoreProps(store, update, props) {
  return _RVRXLUKNcjs.useCompositeStoreProps.call(void 0, store, update, props);
}
function useMenubarStore(props = {}) {
  const [store, update] = _76LCMKUIcjs.useStore.call(void 0, Core.createMenubarStore, props);
