...
var _SQHULPZ2cjs = require('./SQHULPZ2.cjs');


var _MNH5LHM4cjs = require('./MNH5LHM4.cjs');
...
var useComboboxItem = _6TI3NXX6cjs.createHook.call(void 0, 
  function useComboboxItem2(_a) {
    ...
    var _a2;
    const context = _SQHULPZ2cjs.useComboboxScopedContext.call(void 0, );
    store = store || context;
    ...
    props = _L5A2ID7Scjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _SQHULPZ2cjs.ComboboxItemValueContext.Provider, { value, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _SQHULPZ2cjs.ComboboxItemCheckedContext.Provider, { value: selected != null ? selected : false, children: element }) }),
      [value, selected]
    );
    const popupRole = _react.useContext.call(void 0, _SQHULPZ2cjs.ComboboxListRoleContext);
    ...
    props = _MNH5LHM4cjs.useCompositeItem.call(void 0, _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
      store
    }, props), {
      getItem,
