...
var _2C4LCZ5Bcjs = require('./2C4LCZ5B.cjs');
...
function useCompositeItemOffscreen(_a) {
  ...
  const offscreenProps = _2C4LCZ5Bcjs.useCollectionItemOffscreen.call(void 0, _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
    id,
    store,
...
var CompositeItem2 = _6TI3NXX6cjs.forwardRef.call(void 0, function CompositeItem3(_a) {
  ...
  if (active) {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _MNH5LHM4cjs.CompositeItem, _7EQBAZ46cjs.__spreadValues.call(void 0, {}, allProps));
  }
  const _b2 = allProps, {
    store,
    rowId,
