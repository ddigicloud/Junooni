...
function useStoreProps(store, props, key, setKey) {
  ...
  const propsRef = _L5A2ID7Scjs.useLiveRef.call(void 0, { value, setValue });
...
function useStore(createStore, props) {
  ...
  _L5A2ID7Scjs.useSafeLayoutEffect.call(void 0, () => _store.init.call(void 0, store), [store]);
  ...
  const updateStore = _L5A2ID7Scjs.useEvent.call(void 0, () => {
