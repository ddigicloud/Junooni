...
function useCollectionStoreProps(store, update, props) {
  _L5A2ID7Scjs.useUpdateEffect.call(void 0, update, [props.store]);
  _76LCMKUIcjs.useStoreProps.call(void 0, store, props, "items", "setItems");
  return store;
}
function useCollectionStore(props = {}) {
  const [store, update] = _76LCMKUIcjs.useStore.call(void 0, Core.createCollectionStore, props);
