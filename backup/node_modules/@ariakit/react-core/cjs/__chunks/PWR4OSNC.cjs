...
var _4WTKUZTYcjs = require('./4WTKUZTY.cjs');
...
function findById(items, id, baseId) {
  return items.findIndex((item, index) => {
    var _a;
    const itemId = _4WTKUZTYcjs.getCollectionRendererItemId.call(void 0, item, index, baseId);
...
function useCompositeRenderer(_a) {
  ...
  return _4WTKUZTYcjs.useCollectionRenderer.call(void 0, _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
    id,
    store,
    orientation,
    persistentIndices
