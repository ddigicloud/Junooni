...
var TagName = "div";
var useCompositeRow = _6TI3NXX6cjs.createHook.call(void 0, 
  function useCompositeRow2(_a) {
    ...
    props = _L5A2ID7Scjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _CWQU4R75cjs.CompositeRowContext.Provider, { value: providerValue, children: element }),
      [providerValue]
    );
    props = _7EQBAZ46cjs.__spreadValues.call(void 0, { id }, props);
    return _misc.removeUndefinedValues.call(void 0, props);
  }
);
var CompositeRow = _6TI3NXX6cjs.forwardRef.call(void 0, function CompositeRow2(props) {
