...
function useDialogStoreProps(store, update, props) {
  return _ZRZUZ7E7cjs.useDisclosureStoreProps.call(void 0, store, update, props);
}
function useDialogStore(props = {}) {
  const [store, update] = _76LCMKUIcjs.useStore.call(void 0, Core.createDialogStore, props);
