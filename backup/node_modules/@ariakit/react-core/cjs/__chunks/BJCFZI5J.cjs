...
function useFormStoreProps(store, update, props) {
  ...
  _76LCMKUIcjs.useStoreProps.call(void 0, store, props, "errors", "setErrors");
  _76LCMKUIcjs.useStoreProps.call(void 0, store, props, "touched", "setTouched");
  ...
  const useValidate = _react.useCallback.call(void 0, 
    (callback) => {
      callback = _L5A2ID7Scjs.useEvent.call(void 0, callback);
...
function useFormStore(props = {}) {
  const [store, update] = _76LCMKUIcjs.useStore.call(void 0, Core.createFormStore, props);
