...
var _LBJ5Z57Ocjs = require('../__chunks/LBJ5Z57O.cjs');
...
var _U5JOKL4Icjs = require('../__chunks/U5JOKL4I.cjs');
...
var useMenuItemRadio = _6TI3NXX6cjs.createHook.call(void 0, 
  function useMenuItemRadio2(_a) {
    ...
    const context = _JLUMKCNRcjs.useMenuScopedContext.call(void 0, );
    store = store || context;
    ...
    props = _L5A2ID7Scjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _JLUMKCNRcjs.MenuItemCheckedContext.Provider, { value: !!isChecked, children: element }),
      [isChecked]
    );
    props = _7EQBAZ46cjs.__spreadValues.call(void 0, {
      role: "menuitemradio"
    }, props);
    props = _U5JOKL4Icjs.useRadio.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
      name,
      value,
      checked: isChecked,
      onChange(event) {
    ...
    props = _LBJ5Z57Ocjs.useMenuItem.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store, hideOnClick }, props));
    return props;
  }
);
