...
var _UHDKHSPLcjs = require('../__chunks/UHDKHSPL.cjs');
...
function useMenuBarStoreProps(store, update, props) {
  return _UHDKHSPLcjs.useMenubarStoreProps.call(void 0, store, update, props);
}
function useMenuBarStore(props = {}) {
  ...
  return _UHDKHSPLcjs.useMenubarStore.call(void 0, props);
}
