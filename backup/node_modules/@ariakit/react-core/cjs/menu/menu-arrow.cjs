...
var _SOPB75EScjs = require('../__chunks/SOPB75ES.cjs');
...
var TagName = "div";
var useMenuArrow = _6TI3NXX6cjs.createHook.call(void 0, 
  function useMenuArrow2(_a) {
    var _b = _a, { store } = _b, props = _7EQBAZ46cjs.__objRest.call(void 0, _b, ["store"]);
    const context = _JLUMKCNRcjs.useMenuContext.call(void 0, );
    store = store || context;
    return _SOPB75EScjs.usePopoverArrow.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store }, props));
  }
);
var MenuArrow = _6TI3NXX6cjs.forwardRef.call(void 0, function MenuArrow2(props) {
