...
const PLANS = [
  {
    ...
    features: [
      ...
      { icon: <Tag className="w-3.5 h-3.5" />, text: "Store stays in Draft", included: true },
      { icon: <Shield className="w-3.5 h-3.5" />, text: "Junooni branding on store", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: <Shield className="w-3.5 h-3.5" />, text: "Custom domain", included: true },
      { icon: <Wallet className="w-3.5 h-3.5" />, text: "Standard payouts (T+7)", included: true },
      ...
      <div className="sticky top-0 z-30 border-b border-gray-200 shadow-sm bg-white/90 backdrop-blur-md">
        <div className="container flex items-center justify-between px-4 py-3 mx-auto">
          <div className="flex items-center gap-3">
            ...
            <Link to="/store/collections" className="flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-700 transition-colors">
