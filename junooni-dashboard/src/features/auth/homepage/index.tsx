...
const JunooniLandingPage = () => {
  ...
  return (
    <div className="min-h-screen text-gray-900 bg-white">
            ...
            <div>
              ...
              <div className="flex flex-col gap-4 mt-8 sm:flex-row">
                <Button size="lg" onClick={handleRegisterClick} className="px-8 py-4 text-lg font-semibold text-white rounded-lg" style={{ backgroundColor: '#e65100' }}>
                  Start Designing Free <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
      ...
      {/* WE ARE BUILT DIFFERENTLY - Blinkstore inspired */}
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[gallery1, gallery2, gallery3, gallery4].map((img, idx) => (
              <div key={idx} className="overflow-hidden transition shadow-sm rounded-2xl hover:shadow-md">
                <img src={img} alt={`gallery-${idx}`} className="object-cover w-full h-56" />
