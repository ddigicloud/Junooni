...
//             <span>You have {pendingChangesCount} unsaved inventory {pendingChangesCount === 1 ? 'change' : 'changes'}.</span>
//             <Button 
//               onClick={saveInventoryChanges} 
//               disabled={isSaving}
//               className="ml-4 text-white bg-yellow-600 hover:bg-yellow-700"
//               size="sm"
//             >
//               {isSaving ? (
//                 <>
...
//           className="md:w-auto"
//         >
//           <TabsList className="w-full h-auto p-1 bg-gray-100 rounded-md">
//             <TabsTrigger 
//               value="all" 
...
//       {variants.length === 0 && (
//         <div className="p-8 text-center border border-gray-300 border-dashed rounded-md bg-gray-50">
//           <IconPackage className="w-12 h-12 mx-auto mb-3 text-gray-400" />
//           <h3 className="mb-1 text-lg font-medium text-gray-700">No variants found</h3>
