...
export const getStorefrontData = cache(
  async (
    ...
    const url = `${BACKEND}/storefront/${handle}`
...
// Hits the lightweight /storefront/:handle/products endpoint — no vendor_store
...
export const getStoreProducts = cache(
  async (
    ...
    const callId = Math.random().toString(36).slice(2, 6)
    const url = `${BACKEND}/storefront/${handle}/product?page=${page}`
...
export const getStoreCategories = cache(
  async (handle: string): Promise<{
    ...
    const callId = Math.random().toString(36).slice(2, 6)
    const url = `${BACKEND}/storefront/${handle}/categories`
...
export const getStoreCollections = cache(
  async (handle: string): Promise<{
    ...
    const callId = Math.random().toString(36).slice(2, 6)
    const url = `${BACKEND}/storefront/${handle}/collections`
...
export const getStoreCategoryDetail = cache(
  async (handle: string, categoryHandle: string): Promise<{
    ...
    const callId = Math.random().toString(36).slice(2, 6)
    const url = `${BACKEND}/storefront/${handle}/categories/${categoryHandle}`
...
export const getStoreCollectionDetail = cache(
  async (handle: string, collectionHandle: string): Promise<{
    ...
    const callId = Math.random().toString(36).slice(2, 6)
    const url = `${BACKEND}/storefront/${handle}/collections/${collectionHandle}`
...
export const getStoreShell = cache(
  async (
    ...
    const url = `${BACKEND}/storefront/${handle}?shell=true`
