// // src/app/[handle]/not-found.tsx
// // Shown when notFound() is called — e.g. invalid handle or backend 404
...
//           Store not found
//         </h1>
//         <p style={{ color: "#888", fontSize: "0.875rem", lineHeight: 1.6, marginBottom: "1.5rem" }}>
//           This store doesn't exist or the link may be incorrect.
//         </p>
//         <a href="https://junooni.com" style={{
//           display: "inline-block", padding: "0.5rem 1.25rem",
//           borderRadius: "8px", background: "#e65100",
