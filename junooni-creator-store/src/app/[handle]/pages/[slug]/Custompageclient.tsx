...
export default function CustomPageClient({
  ...
  vendor, initialStore, categories = [], collections = [], products = [],
}: Props) {
    ...
    return (
      ...
      >
        ...
        {section.type === "video" && (() => {
          ...
          if (!raw) {
            return (
              <div className="px-4 py-12 sm:px-6" style={{ backgroundColor: sectionBg ?? "transparent" }}>
                <div className="max-w-4xl mx-auto">
                  ...
                  <div className="flex items-center justify-center bg-gray-100 border-2 border-gray-300 border-dashed rounded-2xl aspect-video">
                    <div className="text-center">
                      <span className="text-5xl">🎬</span>
                      <p className="mt-2 text-sm text-gray-400">Add a YouTube or Vimeo URL in the left panel</p>
                    </div>
                  </div>
                </div>
              </div>
