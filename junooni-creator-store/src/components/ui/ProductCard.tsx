...
export default function ProductCard({
  ...
  const swatchAlignClass = alignment === "center" ? "justify-center" : "justify-start"
      ...
      <Link href={`/products/${product.handle}`}>
        ...
        >
          ...
          <div className={`relative overflow-hidden bg-gray-100 ${aspectClass}`}>
            ...
            {/* Sold out badge */}
            {showSoldOutBadge && isSoldOut && (
              <div className="absolute top-2 left-2 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-black/60 text-white z-10">
                Sold out
              </div>
            )}
          ...
          <div className={`p-3 ${alignClass}`}>
            <h2 className={`font-medium text-md leading-snug mb-1 line-clamp-2 h-10 ${
            ...
            {visibleSwatches.length > 0 && (
              <div className={`flex items-center gap-1.5 mb-2 ${swatchAlignClass}`}>
