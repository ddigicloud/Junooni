...
function MinimalSection({ section, vendor, store, products, categories, collections, brandPrimary, sectionBg, sectionText }: {
  ...
  switch (section.type) {
    ...
    case "divider": {
      return <hr className="mt-4 border-gray-100" />
    }
          ...
          <div className="max-w-6xl mx-auto">
            <div className={`flex flex-col gap-10 items-center ${imageLeft ? "md:flex-row" : "md:flex-row-reverse"}`}>
              ...
              <div className="flex-1">
                ...
                {section.text && (
                  <p className="mb-6 text-base leading-relaxed" style={{ color: sectionText ? `${sectionText}cc` : "#4b5563" }}>
                    {section.text}
                  </p>
                )}
                {section.cta_label && (
...
function FeaturedProductWidget({ section, product, handle, brandPrimary, sectionBg, sectionText }: {
 ...
 const isLightHex = (color: string): boolean => {
  ...
  // Fallback for color names when hex lookup fails
  const lightNames = ["white", "off white", "offwhite", "cream", "ivory",
    "eggshell", "pearl", "beige", "sand", "lavender", "baby pink",
    "light pink", "powder blue", "mint", "light gray", "light grey",
    "nude", "snow", "linen", "seashell", "ghostwhite", "floralwhite"
  ]
  return lightNames.some(n => color.toLowerCase().trim() === n)
}
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  {visibleColors.map(colorName => {
                    ...
                    const light = !isGrad ? isLightHex(hex ?? colorName) : false
                      ...
                      <button
                        ...
                        style={{
                          ...
                          boxShadow: isSelected
                            ...
                            : light
                              ? "0 0 0 1px #d1d5db, 0 1px 3px rgba(0,0,0,0.1)"
