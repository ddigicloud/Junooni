  ...
  return (
    <div className={`overflow-hidden ${isDark ? "bg-gray-900" : "bg-white"} border ${isDark ? "border-white/10" : "border-gray-100"} shadow-sm rounded-2xl`}>
      ...
      <div className="flex flex-col items-center gap-6 p-8">
        ...
        {/* CTA */}
        {isPreview ? (
          <div className="w-full py-4 rounded-xl text-center text-sm font-semibold bg-gray-100 text-gray-400 cursor-not-allowed border-2 border-dashed border-gray-200">
            🔒 Cannot place order in editor preview
          </div>
        ) : (
          <button
