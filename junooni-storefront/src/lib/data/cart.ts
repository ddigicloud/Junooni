...
export async function retrieveCart(cartId?: string) {
  ...
  return await sdk.client
    .fetch<HttpTypes.StoreCartResponse>(`/store/carts/${id}`, {
      ...
      query: {
        fields:
          "*items, *region, *items.product, *items.variant, *items.variant.product, *items.variant.product.images, *items.thumbnail, *items.metadata, +items.total, +items.variant_id, *promotions, +shipping_methods.name",
      },
      headers,
      next,
      cache: "force-cache",
