...
//             <input
//               type="checkbox"
//               className="w-4 h-4 mr-3 text-pink-500 border-gray-300 rounded focus:ring-pink-500"
...
//           placeholder="Min"
//           className="w-full px-3 py-2 text-sm border border-gray-300 rounded-sm focus:ring-pink-500 focus:border-pink-500"
//         />
