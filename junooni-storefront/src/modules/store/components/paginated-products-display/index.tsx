    ...
    <div className="w-full">
      ...
      >
        {products.map((product, index) => {
          ...
          return (
            <li key={product.id} className="overflow-hidden transition-shadow bg-white border border-gray-100 rounded-none md:rounded-lg shadow-sm group hover:shadow-md">
              <ProductPreview 
                product={product} 
                region={region}
