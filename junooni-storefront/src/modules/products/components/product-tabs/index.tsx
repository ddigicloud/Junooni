                  ...
                  <div className="p-3 mb-4 rounded-md bg-blue-50 sm:p-4 sm:mb-6">
                    <div className="flex items-center mb-1 sm:mb-2">
                      ...
                      <h3 className="text-sm font-medium sm:text-base">
                        {fulfillmentType.type || "Fulfillment Type"}
                      </h3>
                    </div>
                    {(fulfillmentType.handling_time || fulfillmentType.shipping_time) && (
                      <p className="text-xs text-gray-700 sm:text-sm">
                        {fulfillmentType.handling_time && `Processing: ${fulfillmentType.handling_time} days`}
                        {fulfillmentType.handling_time && fulfillmentType.shipping_time && " • "}
                        {fulfillmentType.shipping_time && `Shipping: ${fulfillmentType.shipping_time} days`}
                      </p>
                    )}
                  </div>
                )} */}
