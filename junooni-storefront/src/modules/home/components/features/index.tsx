      ...
      <div className="container relative px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3 lg:gap-8">
          {features.map((feature, index) => (
            ...
            >
              {/* Card */}
              <div className="relative h-full p-6 overflow-hidden transition-all duration-300 transform bg-white border border-gray-100 shadow-lg rounded-2xl sm:p-8 hover:shadow-2xl hover:-translate-y-1">
                ...
                <div className="relative mb-6">
                  ...
                  <div className={`absolute inset-0 ${feature.iconBg} rounded-2xl blur-2xl opacity-20 scale-150`}></div>
                </div>
                ...
                {/* Learn more link */}
                {/* <div className="mt-6 transition-opacity duration-300 sm:opacity-0 sm:group-hover:opacity-100">
                  <a 
                    href="#" 
                    className="inline-flex items-center text-sm font-semibold text-orange-600 transition-colors hover:text-orange-700"
                  >
                    Learn more
                    <svg className="w-4 h-4 ml-1 transition-transform transform group-hover:translate-x-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="mt-12 text-center sm:mt-16">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <a 
              href="/store" 
              className="inline-flex items-center justify-center px-6 py-3 font-semibold text-white transition-all duration-200 transform rounded-lg shadow-lg bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 hover:scale-105"
            >
              Start Shopping
            ...
            <a 
              ...
              className="inline-flex items-center justify-center px-6 py-3 font-semibold text-gray-700 transition-all duration-200 border-2 border-gray-300 rounded-lg hover:border-gray-400 hover:bg-gray-50"
            >
              Become a Creator
            </a>
          </div>
