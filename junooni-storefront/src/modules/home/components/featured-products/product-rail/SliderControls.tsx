...
export default function SliderControls({ sliderId, itemCount }: SliderControlsProps) {
  ...
  const scrollPrev = useCallback(() => {
    ...
    // Scroll back by 1 item width (approximately 1/3 of container on desktop)
  ...
  const scrollNext = useCallback(() => {
    ...
    // Scroll forward by 1 item width (approximately 1/3 of container on desktop)
    const scrollAmount = containerWidth / 2
    sliderContainer.scrollBy({ left: scrollAmount, behavior: 'smooth' })
  }, [sliderId, containerWidth])
  ...
  return (
    <>
      <button
        ...
        className="absolute left-0 z-10 p-2 transform -translate-y-1/2 bg-white rounded-full shadow-md top-1/2 disabled:opacity-50"
      ...
      <button
        ...
        className="absolute right-0 z-10 p-2 transform -translate-y-1/2 bg-white rounded-full shadow-md top-1/2 disabled:opacity-50"
