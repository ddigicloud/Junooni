...
// // ─── SkeletonCard: fixed pixel height, no aspect-ratio trick ─────────────────
// function SkeletonCard() {
//   return (
//     <div className="w-full animate-pulse">
//       <div className="w-full bg-gray-200 rounded" style={{ height: "200px" }} />
//       <div className="w-2/3 h-4 mt-3 bg-gray-200 rounded" />
//       <div className="w-full h-3 mt-2 bg-gray-100 rounded" />
//     </div>
//   );
// }
...
//             {/* Skeleton: shown before JS mounts. Fixed 200px height — no aspect-ratio = no oversizing. */}
//             {!mounted && (
...
//             {/* Swiper only mounts after useEffect — browser already knows viewport width */}
//             {mounted && (
//               <>
//                 <Swiper
//                   slidesPerView={1.2}
...
// ─── Lazy-load Swiper — keeps it out of the main bundle ──────────────────────
    ...
    <section className="relative py-20 bg-gray-50">
      <div className="container px-2 mx-auto sm:px-5">
        ...
        <div className="relative -mx-2 overflow-hidden sm:mx-0">
          <div className="px-2 sm:px-0">
            {/* 
              SSR fallback: shown before Swiper hydrates.
              Matches desktop layout so there's no jarring shift.
              Hidden on mobile (where Swiper handles layout).
            */}
            ...
            {/* Swiper loads client-side only, replaces the grid above */}
            <div className="sm:hidden vendor-swiper-wrapper">
              <Swiper
                slidesPerView={1.2}
                spaceBetween={16}
                navigation={{
