              ...
              {submenuItems.map((level2Item, level2Index) => (
                <div key={level2Index} className="mb-6">
                  ...
                  <LocalizedClientLink
                    ...
                    className="block mb-3 text-lg font-medium text-gray-800 transition-all duration-200 hover:text-[#e65100]"
                  >
                    {level2Item.label}
                  </LocalizedClientLink>
                      ...
                      {level2Item.submenuItems.map((level3Item, level3Index) => (
                        <li key={level3Index}>
                          <LocalizedClientLink
                            ...
                            className="block text-sm text-black transition-all duration-200 hover:text-[#e65100]"
                          >
                            {level3Item.label}
                          </LocalizedClientLink>
                        </li>
